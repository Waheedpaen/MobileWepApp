...
import { IOperatingSystemRepository, IRepository } from 'src/app/Shared/common-classes/Irepoository/IRepository';
...
export class OperatingsystemRepositoryService extends  IOperatingSystemRepository {
  ...
  GetAll() {
    return this.http.get(environment.urlOperatingSystem + '/OperatingSystemList');
  }
  GetData(id: number) {
  return this.http.get(environment.urlOperatingSystem + '/OperatingSystemDetail/' + id);
  }
  SaveData(obj: any) {
  return this.http.post(environment.urlOperatingSystem + '/SaveOperatingSystemData',obj);
  }
  DeleteData(id: number) {
  return  this.http.delete(environment.urlOperatingSystem + '/DeleteOperatingSystemData/' + id);
  }
  UpdateData(obj: any) {
    return this.http.put(environment.urlOperatingSystem + '/UpdateOperatingSystemData',obj);
  }
  SearchData(obj: any) {
    return this.http.get(environment.urlOperatingSystem + '/SearchData/'+ obj);
  }
